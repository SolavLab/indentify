function [meshStruct]=hexMeshNUBox(varargin)

% function [meshStruct]=hexMeshNUBox(boxDim,boxEl,outputStructType)
% ------------------------------------------------------------------------
%
%
% Kevin Mattheus Moerman and Amit Ashkenazi
% gibbon.toolbox@gmail.com
% 
% 2014/09/25
% 2023/06/03 Reimagine the function for non uniform meshing
%------------------------------------------------------------------------
...
%Creating 2D slice
[X2,Y2]=meshgrid(exp(linspace(-dX/2,dX/2,nX+1)),exp(linspace(-dY/2,dY/2,nY+1))); %mesh of single slice
